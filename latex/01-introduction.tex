...
\begin{enumerate}
    ...
    \item \textbf{Fault-tolerance and zero-shot generalization:} The introduction of a fault-aware training regime that sustains near-zero throughput loss under 15\% random link failures. Furthermore, the model exhibits robust zero-shot transferability from $4\times4$ to $8\times8$ mesh scales, achieving 99.78\% minimal-port routing accuracy and outperforming XY routing by up to 25\% under hotspot traffic.
\end{enumerate}
