...
def generate_experiments(limit_topology=None):
    ...
    if limit_topology == 'mesh4':
        topos = [('mesh',4,2)]
        gnn_algos = {('mesh',4,2): 'gnn_port_score_route_4x4'}
    elif limit_topology == 'mesh8':
        topos = [('mesh',8,2)]
        gnn_algos = {('mesh',8,2): 'gnn_ppo_route_8x8'}
    else:
        topos = [('mesh',4,2), ('mesh',8,2), ('torus',4,2)]
        gnn_algos = {('mesh',4,2): 'gnn_port_score_route_4x4', ('mesh',8,2): 'gnn_ppo_route_8x8'}
    
    baselines = ['dor', 'adaptive_xy_yx', 'min_adapt', 'planar_adapt', 'romm', 'valiant']
